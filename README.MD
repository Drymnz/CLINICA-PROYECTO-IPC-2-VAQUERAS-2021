...
```bash
docker run -p 5000:5000  -e MYSQLHOST='192.168.1.27'  -e MYSQLUSER='clinicaMedicadmin' -e MYSQLPASS='Password123$' -v "$(pwd)/api/:/app/api/" -v "$(pwd)/views/:/app/views/" -v "$(pwd)/public/:/app/public/" -it 1ca13f798f5f
```
